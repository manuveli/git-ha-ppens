...
### Fixed
- Exclude Home Assistant Core/Container backup archives from the live configuration repository, safely migrate already tracked archives out of the Git index, and preserve user-managed ignore rules and unrelated repository state ([#84](https://github.com/manuveli/git-ha-ppens/issues/84)).

## [1.4.0] - 2026-09-20

### Added
- Add a reversible Home Assistant repair that safely migrates eligible ESPHome Device Builder repositories into the main repository, preserves recovery data, and blocks ambiguous or unsafe layouts. ([#83](https://github.com/manuveli/git-ha-ppens/issues/83))

## [1.3.2] - 2026-09-19

### Fixed
- Detect and block undeclared embedded Git repositories, provide an actionable Home Assistant repair, and auto-push clean commits created by external tools such as ESPHome. ([#83](https://github.com/manuveli/git-ha-ppens/issues/83))

## [1.3.1] - 2026-09-09

### Fixed
- Automatically recover divergent repositories after a pre-deploy rejection by using deterministic merge pulls, aborting conflicts cleanly, and publishing validated recovery merges when Auto-Push is enabled ([#82](https://github.com/manuveli/git-ha-ppens/issues/82)).

## [1.3.0] - 2026-09-01

### Fixed
- Validate remote commits merged during push conflict recovery, roll back failed pre-deploy checks, and remove the automatic force-push fallback (#82)
...
### Fixed
- Fixed structured AI conversation errors being used as commit messages while preserving permissive message formatting and deterministic fallback commits. (#80)
...
### Fixed
- Prevent URL credential redaction from consuming following structured-data fields (#77).

### Security
- Use non-persistent, prompt-local placeholders to distinguish changed secrets without exposing stable fingerprints (#77).
...
[1.4.1]: https://github.com/manuveli/git-ha-ppens/compare/v1.4.0...v1.4.1
[1.4.0]: https://github.com/manuveli/git-ha-ppens/compare/v1.3.2...v1.4.0
[1.3.2]: https://github.com/manuveli/git-ha-ppens/compare/v1.3.1...v1.3.2
[1.3.1]: https://github.com/manuveli/git-ha-ppens/compare/v1.3.0...v1.3.1
[1.3.0]: https://github.com/manuveli/git-ha-ppens/compare/v1.2.2...v1.3.0
